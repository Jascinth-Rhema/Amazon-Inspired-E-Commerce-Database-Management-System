...
- Design a normalized relational database for online shopping.
- Manage customer, seller, and administrator information efficiently.
- Maintain product details, categories, and inventory records.
- Support shopping cart and wishlist management.
...
- Perform efficient SQL operations for data management.
- Ensure database security and integrity.
- Support future expansion and additional business requirements.
...
### Performance
- Fast retrieval and processing of large volumes of data.

### Reliability
- Accurate and consistent information with minimal downtime.

### Security
- Protect customer information and payment details using secure database practices.

### Scalability
- Support future expansion with more customers, products, and transactions.

### Data Integrity
- Maintain accurate relationships using Primary Keys, Foreign Keys, and constraints.

### Maintainability
- Easy to maintain, update, and modify.

### Availability
- Ensure the database is available whenever required.

### Backup and Recovery
- Support backup and recovery to prevent data loss.

### Usability
- Provide an organized and easy-to-understand database structure.
